import require$$0 from 'rescript/lib/js/js_exn.js';
import require$$1 from 'rescript/lib/js/js_dict.js';
import require$$2 from 'rescript/lib/js/js_types.js';
import require$$3 from 'rescript/lib/js/caml_option.js';
import require$$4 from 'rescript/lib/js/caml_exceptions.js';
import require$$5 from 'rescript/lib/js/caml_js_exceptions.js';
...
var Js_exn$1 = require$$0;
var Js_dict = require$$1;
var Js_types = require$$2;
var Caml_option = require$$3;
var Caml_exceptions = require$$4;
var Caml_js_exceptions$1 = require$$5;
...
function getSerializeOperation(struct) {
  ...
  compiledSerializeOperation = typeof fn === "number" ? undefined : (
      fn.TAG === /* SyncOperation */0 ? fn._0 : panic$1()
    );
...
function parseWith(any, struct) {
  try {
    ...
    var internalError = Caml_js_exceptions$1.internalToOCamlException(raw_internalError);
...
function refine$1(struct, maybeRefineParser, maybeRefineSerializer, param) {
...
function asyncRefine$1(struct, parser, param) {
  return {
          n: struct.n,
          t: struct.t,
...
function transform$1(struct, maybeTransformParser, maybeTransformSerializer, param) {
  ...
  if (typeof unionStructs !== "number" && unionStructs.TAG === /* Union */6) {
    var tagged = {
      ...
      _0: unionStructs._0.map(function (unionStruct) {
            return advancedPreprocess(unionStruct, maybePreprocessParser, maybePreprocessSerializer);
          })
    };
    return {
            n: struct.n,
...
function custom$2(name, maybeCustomParser, maybeCustomSerializer, param) {
...
function factory$1$1(innerLiteral) {
  if (typeof innerLiteral === "number") {
...
function strip$1(struct) {
  return set(struct, metadataId, /* Strip */1);
}

function strict$1(struct) {
...
function min(struct, maybeMessage, length) {
  ...
  return refine$1(struct, refiner, refiner);
}
...
function trimmed(struct, param) {
  ...
  return transform$1(struct, transformer, transformer);
}
          ...
          pf: (function (ctx, struct) {
              ...
              planSyncTransformation(ctx, (function (input) {
                      ...
                      try {
                        ...
                        var obj = Caml_js_exceptions$1.internalToOCamlException(raw_obj);
                        if (obj.RE_EXN_ID === Js_exn$1.$$Error) {
...
var never$2 = factory$3;

var unknown$2 = factory$4;

var string$2 = factory$5;
...
var literal$2 = factory$1$1;

var literalVariant = factory$1;

var array$2 = factory$13;
...
var json$2 = factory$6;

var union$2 = factory$17;

var deprecated = factory$12;

var defaulted$2 = factory$15;
...
S_bs.Raised = Raised;
S_bs.never = never$2;
S_bs.unknown = unknown$2;
S_bs.string = string$2;
S_bs.bool = bool;
S_bs.$$int = $$int;
S_bs.$$float = $$float;
S_bs.literal = literal$2;
S_bs.literalVariant = literalVariant;
S_bs.array = array$2;
S_bs.dict = dict;
S_bs.option = option;
S_bs.$$null = $$null;
S_bs.json = json$2;
S_bs.union = union$2;
S_bs.deprecated = deprecated;
S_bs.defaulted = defaulted$2;
S_bs.transform = transform$1;
S_bs.advancedTransform = advancedTransform;
S_bs.advancedPreprocess = advancedPreprocess;
S_bs.custom = custom$2;
S_bs.refine = refine$1;
S_bs.asyncRefine = asyncRefine$1;
S_bs.parseWith = parseWith;
S_bs.parseOrRaiseWith = parseOrRaiseWith;
S_bs.parseAsyncWith = parseAsyncWith;
S_bs.parseAsyncInStepsWith = parseAsyncInStepsWith;
S_bs.serializeWith = serializeWith;
S_bs.serializeOrRaiseWith = serializeOrRaiseWith;
S_bs.isAsyncParse = isAsyncParse;
S_bs.recursive = recursive;
S_bs.asyncRecursive = asyncRecursive;
S_bs.$$Object = $$Object$1;
S_bs.object = object$1;
S_bs.field = field;
S_bs.discriminant = discriminant;
S_bs.Tuple = Tuple;
S_bs.tuple0 = tuple0;
S_bs.tuple1 = tuple1;
S_bs.tuple2 = tuple2;
...
S_bs.tuple8 = tuple8;
S_bs.tuple9 = tuple9;
S_bs.tuple10 = tuple10;
S_bs.classify = classify;
S_bs.name = name;
S_bs.$$String = $$String;
S_bs.Int = Int;
S_bs.Float = Float;
S_bs.$$Array = $$Array;
S_bs.Defaulted = Defaulted;
S_bs.Deprecated = Deprecated;
S_bs.Result = Result$1;
S_bs.Metadata = Metadata;

var Js_exn = require$$0;
var S$ReScriptStruct = S_bs;
var Caml_js_exceptions = require$$5;
...
class ReScriptStructError extends Error {
    ...
    S_JsApi_bs.ReScriptStructError = ReScriptStructError
;
...
function defaulted$1(struct, value) {
...
S_JsApi_bs.$$Error = $$Error;
S_JsApi_bs.Result = Result;
S_JsApi_bs.string = string$1;
S_JsApi_bs.$$boolean = $$boolean;
S_JsApi_bs.integer = integer$1;
S_JsApi_bs.number = number$1;
S_JsApi_bs.never = never$1;
S_JsApi_bs.unknown = unknown$1;
S_JsApi_bs.optional = optional$1;
S_JsApi_bs.nullable = nullable$1;
S_JsApi_bs.array = array$1;
S_JsApi_bs.record = record$1;
S_JsApi_bs.json = json$1;
S_JsApi_bs.union = union$1;
S_JsApi_bs.literal = literal$1;
S_JsApi_bs.nan = nan$1;
S_JsApi_bs.defaulted = defaulted$1;
S_JsApi_bs.tuple = tuple$1;
S_JsApi_bs.custom = custom$1;
S_JsApi_bs.$$Object = $$Object;

const S_Js = S_JsApi_bs;
const S = S_bs;

var StructError = S_JsApi.StructError = S_Js.ReScriptStructError;
var string = S_JsApi.string = S_Js.string;
var boolean = S_JsApi.boolean = S_Js.$$boolean;
var integer = S_JsApi.integer = S_Js.integer;
var number = S_JsApi.number = S_Js.number;
var never = S_JsApi.never = S_Js.never;
var unknown = S_JsApi.unknown = S_Js.unknown;
var optional = S_JsApi.optional = S_Js.optional;
var nullable = S_JsApi.nullable = S_Js.nullable;
var array = S_JsApi.array = S_Js.array;
var record = S_JsApi.record = S_Js.record;
var json = S_JsApi.json = S_Js.json;
var union = S_JsApi.union = S_Js.union;
var object = S_JsApi.object = S_Js.$$Object.factory;
var custom = S_JsApi.custom = S_Js.custom;
var literal = S_JsApi.literal = S_Js.literal;
var nan = S_JsApi.nan = S_Js.nan;
var defaulted = S_JsApi.defaulted = S_Js.defaulted;
var tuple = S_JsApi.tuple = S_Js.tuple;
var raiseError = S_JsApi.raiseError = S.$$Error.raise;

export { StructError, array, boolean, custom, S_JsApi as default, defaulted, integer, json, literal, nan, never, nullable, number, object, optional, raiseError, record, string, tuple, union, unknown };
